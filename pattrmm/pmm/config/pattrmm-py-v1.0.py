...
overlay_prefix: "Returning Soon"     # Text to display before the dates.
...
thisDay = date.today() + timedelta(days=int(dayCounter))
thisDayDisplay = thisDay.strftime("%m/%d/%Y")
if vars.setting('zeros') == True or vars.setting('zeros') != False:
    thisDayDisplayText = thisDay.strftime("%m/%d")
